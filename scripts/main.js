;(function (window) {
  ...
  let texts = ['BUENO LUCÍA','SÉ QUE ÚLTIMAMENTE','NO OS HE DADO', 'LA ATENCIÓN','QUE MERECÉIS', 'TANTO TÚ','COMO LA PEQUE', 'Y QUE ADEMÁS', 'YA DE POR SÍ','SOY BASTANTE', 'POCO AFECTIVO.', 
  'POR ESO', 'QUIERO APROVECHAR', 'ESTA OPORTUNIDAD', 'PARA INTENTAR EXPRESAR','LO IMPORTANTE', 
  'Y LO MUCHO', 'QUE', 'SIGNIFICÁIS PARA MÍ' ,'AUNQUE NO LO DIGA' ,'NI DEMUESTRE LO SUFICIENTE', 'FELIZ SAN VALENTIN','OS QUIERE' ,'VUESTRO DRAGÓN'];
